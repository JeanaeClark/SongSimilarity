...
# Parameters
client_id = '0cad5195dfd04884b84ba221fe400bff'
client_secret = '212724fad9f6414fb40a0d2caf57f4ee'
username = "22aizhrbh74xoox7ejzf4yaha"
auth_manager = oauth2.SpotifyClientCredentials(client_id=client_id, client_secret=client_secret)
spotify = spotipy.Spotify(auth_manager=auth_manager)

def downloadMP3(playlistid):
    playlist_uri = playlistid
